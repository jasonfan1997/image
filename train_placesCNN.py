...
def main():
    ...
    traindir = '../data/scene_classification/scene_train_images_20170904'
    valdir = '../data/scene_classification/scene_validation_images_20170908'
...
def validate(val_loader, model, criterion):
    ...
    print(' * Prec@1 {top1.avg:.3f} Prec@3 {top5.avg:.3f}'
